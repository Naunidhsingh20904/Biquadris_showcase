*****Due to Policy 71, the source code of this project is only available upon request.*****

For our final project for CS246 during the Fall 2025 term, my group and I made a variation of Tetris called Biquadris. It was written in C++ and adhered to OOP principles. We also implemented many design patterns, followed MVC architecture, adhered to RAII idiom, and ensured the project had low coupling and high cohesion.
